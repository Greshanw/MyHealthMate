                          ...
                          Padding(
                            ...
                            child: SliderTheme(
                              ...
                              child: Slider(
                                ...
                                max: 5,
                                divisions: 5,
                                label: 'Shoulder aches: $symptomlevel2',
                                onChanged: (double value) {
                                  setState(() {
                          ...
                          Padding(
                            ...
                            child: SliderTheme(
                              ...
                              child: Slider(
                                ...
                                max: 5,
                                divisions: 5,
                                label: 'Muscle Pain: $symptomlevel3',
                                onChanged: (double value) {
                                  setState(() {
                          ...
                          Padding(
                            ...
                            child: SliderTheme(
                              ...
                              child: Slider(
                                ...
                                max: 5,
                                divisions: 5,
                                label: 'Weight gain: $symptomlevel5',
                                onChanged: (double value) {
                                  setState(() {
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: SliderTheme(
                              ...
                              child: Slider(
                                value: symptomlevel6.toDouble(),
                                min: 0,
                                max: 5,
                                divisions: 5,
                                label: 'Low back pain: $symptomlevel6',
                                onChanged: (double value) {
                                  setState(() {
                                    symptomlevel6 = value.toDouble();
                      ...
                      child: MaterialButton(
                        onPressed: () async {
                          if (symptomlevel1 > 0 ||
                            ...
                            CollectionReference userBodySymptomsRef = _symptoms
                                .doc(uid)
                                .collection("userBodySymptoms");
                            await userBodySymptomsRef.add({
                              "symptom": symptom,
