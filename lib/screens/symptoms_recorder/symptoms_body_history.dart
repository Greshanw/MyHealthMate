...
class SymptomsBodyHistory extends StatefulWidget {
  const SymptomsBodyHistory({Key? key}) : super(key: key);
...
class _HomePageState extends State<SymptomsBodyHistory> {
