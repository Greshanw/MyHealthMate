...
class SymptomsMentalHistory extends StatefulWidget {
  const SymptomsMentalHistory({Key? key}) : super(key: key);
...
class _HomePageState extends State<SymptomsMentalHistory> {
