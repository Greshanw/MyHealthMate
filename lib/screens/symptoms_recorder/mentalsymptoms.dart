                          ...
                          Padding(
                              ...
                              child: SliderTheme(
                                ...
                                child: Slider(
                                  ...
                                  max: 5,
                                  divisions: 5,
                                  label: 'Irritability: $symptomlevel6',
                                  onChanged: (double value) {
                                    setState(() {
                        ...
                        children: [
                          ...
                          Padding(
                              ...
                              child: SliderTheme(
                                ...
                                child: Slider(
                                  value: symptomlevel7.toDouble(),
                                  min: 0,
                                  max: 5,
                                  divisions: 5,
                                  label: 'Fatigue: $symptomlevel7',
                                  onChanged: (double value) {
                                    setState(() {
                                      symptomlevel7 = value.toDouble();
                                      symptom = 'Fatigue';
                                    });
                                  },
                                ),
                        ...
                        children: [
                          ...
                          Padding(
                              ...
                              child: SliderTheme(
                                ...
                                child: Slider(
                                  value: symptomlevel8.toDouble(),
                                  min: 0,
                                  max: 5,
                                  divisions: 5,
                                  label: 'Confusion: $symptomlevel8',
                                  onChanged: (double value) {
                                    setState(() {
                                      symptomlevel8 = value.toDouble();
                                      symptom = 'Confusion';
                                    });
                                  },
                                ),
