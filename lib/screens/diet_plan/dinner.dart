...
class _DietDinnerState extends State<DietDinner> {
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    final String description = _descriptionController.text;
                    if (topic != null) {
                      await _dietDinner.doc(documentSnapshot!.id).update({
                        "topic": topic,
                        "ingredients": ingredients,
                        "description": description
                      }).then((value) {
                        ...
                        child: Row(
                          children: [
                            TextButton(
                              ...
                              onPressed: () =>
                                  _navigateToDietDinnerView(context),
                            ),
                            TextButton(
                              style: TextButton.styleFrom(
                                backgroundColor: Color(0xEFEFEFFF),
  ...
  void _navigateToDietDinnerView(BuildContext context) {
    Navigator.of(context)
        .push(MaterialPageRoute(builder: (context) => DietDinnerView()));
  }
}
